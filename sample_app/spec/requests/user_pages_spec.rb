...
describe "User Pages" do
  ...
  # Test that the sign up page displays correct h1 and title
  ...
  describe "signup" do
    ...
    # Test that invalid information will not create a user
    describe "with invalid information" do
      it "should not create a user" do
        expect { click_button submit }.not_to change(User, :count)
      end
      
      # Test for error msg after submitting invalid info
    ...
    # Tests for valid sign up information
    describe "with valid information" do
      ...
      # Test that user is sign in after signing up
  ...
  # Tests for edit user functionality
  describe "edit" do
    let(:user) { FactoryGirl.create(:user) }
    before do
      sign_in user
